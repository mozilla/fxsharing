...
export const tokensTable = {
  color: [
    ...
    },
    {
      value: {
        ...
        platform: { default: "color-mix(in srgb, black 10%, var(--color-accent-primary))" }
      },
    ...
    },
    {
      value: {
        ...
        platform: { default: "color-mix(in srgb, black 20%, var(--color-accent-primary))" }
      },
  ...
  "background-color": [
    ...
    {
      value: {
        brand: { default: "color-mix(in srgb, var(--color-accent-primary) 20%, transparent)" },
  ...
  "border-color": [
    ...
    },
    {
      value: {
        ...
        platform: { default: "color-mix(in srgb, currentColor 15%, var(--color-gray-60))" }
      },
...
export const variableLookupTable = {
  ...
  "button-border-color-ghost-active": { default: "var(--button-border-color-active)" },
  "button-border-color-ghost-disabled": { default: "var(--button-border-color-disabled)" },
  "button-border-color-ghost-hover": { default: "var(--button-border-color-hover)" },
