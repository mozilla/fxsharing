  ...
  */
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== undefined && this.__reflectingProperty !== propName) {
      ...
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a = options.converter) === null || _a === void 0 ? void 0 : _a.fromAttribute) !== undefined ? options.converter : defaultConverter;
      // mark state reflecting
...
*/
const policy = trustedTypes ? trustedTypes.createPolicy("lit-html", { createHTML: (s) => s }) : undefined;
...
function resolveDirective(part, value, parent = part, attributeIndex) {
  ...
  const nextDirectiveConstructor = isPrimitive$1(value) ? undefined : value["_$litDirective$"];
...
*/
const isDirectiveResult = (value) => (value === null || value === void 0 ? void 0 : value["_$litDirective$"]) !== undefined;
/**
* Retrieves the Directive class for a DirectiveResult
*/
const getDirectiveClass = (value) => value === null || value === void 0 ? void 0 : value["_$litDirective$"];
/**
