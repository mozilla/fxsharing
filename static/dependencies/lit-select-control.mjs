...
export class SelectControlBaseElement extends MozLitElement {
  ...
  static queries = { fieldset: "moz-fieldset" };
  set value(newValue) {
    this.#value = newValue;
  ...
  */
  ...
  render() {
    return html`
      ...
      >
        ${!this.supportPage ? html`<slot slot="support-link" name="support-link"></slot>` : ""}
        <slot
...
* @returns LitElement
*/
export const SelectControlItemMixin = (superClass) => class extends superClass {
  #controller;
  static properties = {
    name: { type: String },
    value: { type: String },
