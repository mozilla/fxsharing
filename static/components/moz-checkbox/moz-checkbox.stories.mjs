...
const Template = ({ l10nId, checked, label, disabled, iconSrc, description, hasSlottedDescription, accesskey, supportPage, hasSlottedSupportLink, nestedFields, ellipsized, value }) => {
  let checkboxTemplate = html`
    ...
    >
      ${hasSlottedDescription ? html`<div slot="description">test slot text</div>` : ""}
      ${hasSlottedSupportLink ? html`<a slot="support-link" href="www.example.com">Click me!</a>` : ""}
      ${nestedFields ? html`<moz-checkbox slot="nested" data-l10n-id=${ifDefined(l10nId)}>
            </moz-checkbox>
  ...
  `;
  return nestedFields ? html`<moz-fieldset label="Checkbox with nested fields">
        ${checkboxTemplate}
