...
const Template = ({ pressed, disabled, label, description, ariaLabel, l10nId, supportPage, accessKey, iconSrc, hasSlottedSupportLink, nestedFields, ellipsized, inputLayout }) => {
  ...
  `;
  return nestedFields ? html`<moz-fieldset label="Toggle with nested fields"
