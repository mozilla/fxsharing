...
export default class MozToggle extends MozBaseInputElement {
  ...
  static styles = [...MozBaseInputElement.styles ?? [], css`/* From chrome://global/content/elements/moz-toggle.css */
:host {
...
.toggle-button[aria-pressed="true"] {
  ...
  &:enabled:hover:before, &:enabled:hover:active:before {
    background-color: var(--toggle-dot-background-color-on-pressed);
  }

  &:-moz-locale-dir(rtl):before, &:dir(rtl):before {
...
@media not (forced-colors) {
  :host(:state(disabled)) .toggle-button {
    opacity: .4;
  }
}
...
if (!customElements.get("moz-toggle")) { customElements.define("moz-toggle", MozToggle); }
