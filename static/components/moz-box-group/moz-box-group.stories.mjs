...
import "../../dependencies/setting-control.mjs";
export default {
...
function basicTemplate({ type, hasHeader, hasFooter, wrapped }) {
  return html`<moz-box-group
    ...
    >
      ${hasHeader ? html`<moz-box-item
            slot="header"
            data-l10n-id="moz-box-item-header"
          ></moz-box-item>` : ""}
      ${getInnerElements(type, wrapped)}
      ${hasFooter ? html`<moz-box-button
            slot="footer"
            data-l10n-id="moz-box-button-footer"
          ></moz-box-button>` : ""}
    </moz-box-group>
    ${type == "list" ? html`<moz-button class="delete" @click=${appendItem}>
          Add an item
        </moz-button>` : ""}`;
}
...
function basicElements() {
  return html`<moz-box-item data-l10n-id="moz-box-item">
    ...
    <moz-box-item data-l10n-id="moz-box-item">
      <moz-button
        iconsrc="../../assets/edit-outline.svg"
        data-l10n-id="moz-box-edit-action"
        type="ghost"
        slot="actions-start"
      ></moz-button>
...
const appendItem = (event) => {
  ...
  actionButton.iconSrc = "../../assets/delete.svg";
  ...
  items: [
    ...
    }] : [],
    {
      ...
      options: [
        ...
        },
        {
          ...
          controlAttrs: { slot: "actions" }
        },
        {
          id: "slotted-icon-button",
          control: "moz-button",
          l10nId: "moz-box-more-action",
          iconSrc: new URL("../../assets/more.svg", import.meta.url).href,
          controlAttrs: { slot: "actions" }
        }
      ]
    },
    ...
    },
    {
      ...
      options: [{
        ...
        l10nId: "moz-box-more-action",
        iconSrc: new URL("../../assets/more.svg", import.meta.url).href,
        controlAttrs: { slot: "actions-start" }
      }]
    },
    {
      id: "button2",
...
`;
const ReorderableTemplate = ({ type, hasHeader, hasFooter, scrollable }) => html`
  ${standardTemplateHtml({ scrollable })}
  ${basicTemplate({
  type,
  hasHeader,
