...
const Template = ({ type, heading, message, l10nId, width, imageSrc, imageAlignment, hasActionButton, hasSupportLink }) => html`
  <div style="width: ${width}px">
    ...
    >
      ${hasActionButton ? html` <moz-button slot="actions">Actions button</moz-button>` : ""}
      ${hasSupportLink ? html` <a is="moz-support-link" slot="support-link" href="#"></a>` : ""}
    </moz-promo>
  </div>
`;
...
ImageAtStart.args = {
  ...Default.args,
  imageSrc: new URL("../../assets/about-license.svg", import.meta.url).href,
...
SquareImage.args = { ...ImageAtStart.args };
