...
import { html, classMap, css } from "../../dependencies/lit.all.mjs";
import { MozBoxBase } from "../../dependencies/lit-utils.mjs";
import { GROUP_TYPES } from "../moz-box-group/moz-box-group.mjs";
...
export default class MozBoxItem extends MozBoxBase {
  ...
  render() {
    return html`
      ...
      <div class="box-container">
        ${this.isDraggable ? html`<span tabindex="0" class="handle"></span>` : ""}
  ...
  static styles = [...MozBoxBase.styles ?? [], css`/* From chrome://global/content/elements/moz-box-item.css */
...
.box-container, slot[name="actions"], slot[name="actions-start"] {
  display: flex;
  align-items: center;
  gap: var(--space-small);
}
...
.handle {
  ...
  cursor: grab;
  -webkit-mask-image: url("../../assets/move-16.svg");
  mask-image: url("../../assets/move-16.svg");
...
if (!customElements.get("moz-box-item")) { customElements.define("moz-box-item", MozBoxItem); }
