...
import { html, when, ifDefined } from "../../dependencies/lit.all.mjs";
...
const Template = ({ hasFooterLinks, hasIcons, showSearch, type = "", customHeight = "initial" }) => {
  let iconSrc = hasIcons ? "../../assets/settings.svg" : undefined;
  return html`
    <style>
      #page {
        height: ${customHeight};
    ...
    <div id="page">
      <moz-page-nav data-l10n-id="moz-page-nav-heading" type=${ifDefined(type)}>
        ${when(showSearch, () => html`<moz-input-search
              slot="subheading"
        ...
        ${when(hasFooterLinks, () => html` <moz-page-nav-button
                support-page="test"
