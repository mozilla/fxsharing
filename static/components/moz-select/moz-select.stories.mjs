...
const WITH_ICON_DEFAULT_OPTIONS = [
  {
    value: "1",
    l10nId: "moz-option-1",
    iconSrc: new URL("../../assets/settings.svg", import.meta.url).href
  },
  {
    value: "2",
    l10nId: "moz-option-2",
...
const WITH_ICON_OTHER_OPTIONS = [
  {
    value: "A",
    l10nId: "moz-option-a",
    iconSrc: new URL("../../assets/heart.svg", import.meta.url).href
  },
  {
    value: "B",
    l10nId: "moz-option-b",
    iconSrc: new URL("../../assets/edit.svg", import.meta.url).href
  },
  {
    value: "C",
    l10nId: "moz-option-c",
...
const Template = ({ name, value, iconSrc, disabled, l10nId, description, supportPage, accessKey, hasSlottedDescription, useOtherOptions, options = useOtherOptions ? OTHER_OPTIONS : DEFAULT_OPTIONS, hasSlottedSupportLink, ellipsized, disabledOption, hiddenOption, withSeparator, inputLayout }) => html`
  <div style="width:300px">
    ...
    >
      ${hasSlottedDescription ? html`<div slot="description">${description}</div>` : ""}
      ${hasSlottedSupportLink ? html`<a slot="support-link" href="www.example.com">Click me!</a>` : ""}
      ${options.map((opt, i) => html`${i == 2 && withSeparator ? html`<hr />` : ""}
            <moz-option
              value=${opt.value}
