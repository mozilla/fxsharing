...
import { html } from "../../dependencies/lit.all.mjs";
import "../moz-card/moz-card.mjs";
import { PLATFORM_LINUX, PLATFORM_MACOS, PLATFORM_WINDOWS } from "./moz-button-group.mjs";
export default {
...
Windows.args = { platform: PLATFORM_WINDOWS };
export const Mac = Template.bind({});
Mac.args = { platform: PLATFORM_MACOS };
export const Linux = Template.bind({});
Linux.args = { platform: PLATFORM_LINUX };
