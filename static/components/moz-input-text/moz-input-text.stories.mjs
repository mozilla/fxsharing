...
const Template = ({ name, value, iconSrc, disabled, readonly, l10nId, description, supportPage, accessKey, hasSlottedDescription, hasSlottedSupportLink, ellipsized }) => html`
  <moz-input-text
    name=${name}
