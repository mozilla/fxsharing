...
const Template = ({ type, heading, message, l10nId, dismissable, hasSupportLink, hasActionButton, hasSlottedMessage }) => html`
  <moz-message-bar
    type=${type}
  ...
  >
    ${hasSlottedMessage ? html` <span slot="message" data-l10n-id="moz-message-bar-message-slot"
          ><a
