  ...
  render() {
    return html`
      ...
      >
        ...
        <acorn-icon
          class="icon nav-icon"
          src="${new URL("../../assets/arrow-right.svg", import.meta.url).href}"
          alt=""></acorn-icon>
      </button>
    `;
  }
  static styles = [...MozBoxBase.styles ?? [], css`/* From chrome://global/content/elements/moz-box-button.css */
button {
  width: 100%;
}
...
if (!customElements.get("moz-box-button")) { customElements.define("moz-box-button", MozBoxButton); }
