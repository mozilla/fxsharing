...
if (!customElements.get("moz-label")) { customElements.define("moz-label", MozTextLabel, { extends: "label" }); }
function mergeElement(element) {
  ...
  if (Text.hasOwnProperty("isInstance") ? Text.isInstance(element.previousSibling) : element.previousSibling instanceof Text) {
