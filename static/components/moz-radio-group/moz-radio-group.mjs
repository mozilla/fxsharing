...
import { SelectControlBaseElement, SelectControlItemMixin } from "../../dependencies/lit-select-control.mjs";
...
export class MozRadioGroup extends SelectControlBaseElement {
  ...
  static properties = { parentDisabled: {
    type: Boolean,
    state: true
  } };
}
if (!customElements.get("moz-radio-group")) { customElements.define("moz-radio-group", MozRadioGroup); }
/**
...
if (!customElements.get("moz-radio")) { customElements.define("moz-radio", MozRadio); }
