...
let icons = [
  ...
  new URL("../../assets/delete.svg", import.meta.url).href,
  new URL("../../assets/defaultFavicon.svg", import.meta.url).href
];
...
const Template = ({ value = greetings[0], groupL10nId = "moz-radio-group", buttonLabels, groupName, showIcons, disabled, disabledButtons, showDescriptions, showAccesskeys, accesskeys, supportPage, groupSupportPage, hasSlottedSupportLinks, groupSlottedSupportLink, nestedFields, ellipsized, headingLevel }) => html`
  <moz-radio-group
    name=${groupName}
  ...
  >
    ${groupSlottedSupportLink ? html`<a href="/" slot="support-link">Slotted support link</a>` : ""}
    ${greetings.map((greeting, i) => html`
        <moz-radio
        ...
        >
          ${hasSlottedSupportLinks ? html`<a slot="support-link" href="www.example.com">
                Click me!
              </a>` : ""}
          ${nestedFields ? html`<moz-checkbox
                slot="nested"
