...
<Meta title="UI Widgets/Button/README" />
...
<div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
  ...
  <moz-button iconsrc="/assets/more.svg"
              tooltiptext="Icon">
  </moz-button>
  <moz-button iconsrc="/assets/more.svg"
...
```html
<moz-button iconsrc="/assets/edit-copy.svg" label="Button"></moz-button>
```
...
```html
<moz-button iconposition="end" iconsrc="/assets/edit-copy.svg" label="Button"></moz-button>
```
