...
const Template = ({ type, size, l10nId, iconSrc, disabled, accesskey, clickHandler, showOuterPadding, attention, iconPosition, menuId }) => html`
  <style>
    .show-outer-padding {
  ...
  ></moz-button>
  ${menuId ? html` <panel-list id="panel-list">
...
IconText.args = {
  ...Default.args,
  iconSrc: new URL("../../assets/edit-copy.svg", import.meta.url).href,
  l10nId: "moz-button-labelled"
};
